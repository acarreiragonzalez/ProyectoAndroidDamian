...
//clase que controla la pantalla de menu y las diferentes dificultades
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //llamamos a actividadprincipal.xml
    ...
    public void iniciar(View view){
        //establecemos un inttent , donde segund que tipo de dificultad seleccionemos, cambiara su valor y asi los metodos a los que son llamados
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESUL_JUEGO) {
            ...
            if (resultCode == RESULT_OK) {
                //labels donde se nos recojen los datos proporcionados en la Pantalla de Juego para mostrarlo en pantalla
                ...
                dialog.setPositiveButton("Aceptar",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                //serie de ifs, que dependiendo de la difultad, conectan con una serie de atributos establecidos en sus propios metodos (mas abajo)
...
//metodos que cambian los atributos para añadir dificultad, y mejoran la interfaz añadiendo unos colores de seleccion en los botones
    public void normal(View view){
        dificultad = "normal";
        PantallaJuego.poblacion = 4;
        String p = pc.getString("pnormal", "---");
